					...
					<c:forEach items="${inquilinos }" var="inquilino">
						<tr>
							...
							<td class="tdAcciones"><a href="#" id="lnkDetalle"
								...
								title="Ver Detalles del Inquilino"><span class="icon-eye"></span></a>

								<a href="modificarInquilino-${inquilino.idInquilino}.html"
								title="Editar Inquilino"><span class="icon-pencil"></span></a> <a
								href="inquilino-${inquilino.idInquilino}.html"
								title="Abrir página de Detalles"><span class="icon-file"></span></a>

								<a href="#" id="lnkBorrar"
								onclick="borrar(${inquilino.idInquilino})"
								title="Eliminar Inquilino"><span class="icon-remove"></span></a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
